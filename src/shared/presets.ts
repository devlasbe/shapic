import type { PresetType, PresetCategoryType, PresetLookupType } from './types.js'
...
// main process에서 프리셋 조회용 맵 (자동 생성)
export const BUILT_IN_PRESET_MAP: Record<string, PresetLookupType> = Object.fromEntries(
  BUILT_IN_PRESETS.map((p) => [
    p.id,
    { id: p.id, width: p.width, height: p.height, format: p.format, quality: p.quality }
  ])
)
